    ...
    return (
        <div className="mt-4">
            ...
            <form className="w-full" onSubmit={onSubmit}>
                <input title="Only a single word" pattern="[a-zA-ZÅÄÖåäö]*" required className="mr-3 bg-[#2F3E46] text-[#CAD2C5] shadow appearance-none border rounded py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="synonym" type="text" placeholder="New synonym" />
